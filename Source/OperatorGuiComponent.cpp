...
void OperatorGuiComponent::resized()
{
    ...
    {
        case 0:
            setBoundsRelative(0, 0, (1/3), (1/2));
        case 1:
            setBoundsRelative((1/3), 0, (1/3), (1/2));
        case 2:
            setBoundsRelative((2/3), 0, (1/3), (1/2));
        case 3:
            setBoundsRelative(0, (1/2), (1/3), (1/2));
        case 4:
            setBoundsRelative((1/3), (1/2), (1/3), (1/2));
        case 5:
            setBoundsRelative((2/3), (1/2), (1/3), (1/2));
    }
}
